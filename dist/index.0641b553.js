...
const battleship = new (0, _battleship.Battleship)(ROWS, COLUMNS);
battleship.addShip(1, 1, (0, _battleship.HORIZONTAL), 4);
battleship.addShip(5, 3, (0, _battleship.HORIZONTAL), 3);
const board = battleship.board.map((row, rowIndex)=>{
    const rowEl = document.createElement("div");
    rowEl.classList.add("row");
    rowEl.innerHTML = row.map((column, columnIndex)=>{
...
},{"./Battleship":"dh9FF"}],"dh9FF":[function(require,module,exports) {
...
parcelHelpers.export(exports, "Battleship", ()=>Battleship) // addShip(2, 2, "HORIZONTAL", 3);
...
class Battleship {
    ...
    addShip(row, column, direction, length) {
        for(let i = 0; i < length; i++){
            if (direction === HORIZONTAL) this.board[row][column + 1] = 1;
            else if (direction === VERTICAL) this.board[row + 1][column] = 1;
        }
    }
}
...
},{}]},["lKzq4","bNKaB"], "bNKaB", "parcelRequire2e06")
